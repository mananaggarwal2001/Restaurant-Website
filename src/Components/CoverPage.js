        ...
        <div className='flex justify-center py-14'>
            <div className="container p-3 w-max bg-white bg-opacity-50 space-y-4 ">
                <div className="con p-16 border-[3px] border-red-900">
                    ...
                    <button className="btn bg-red-800 border-[2.2px] border-red-900 text-white py-3 px-5 font-bold uppercase hover:bg-inherit hover:border-red-900 hover:border-[2.2px] hover:text-red-900 transition-all duration-200 rounded-md">Look Menu</button>
                </div>
            </div>
        </div>
    )
